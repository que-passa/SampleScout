...
**v1 algorithm (locked):** adaptive **energy-island** segmentation on a mono downmix envelope, with **local-minimum backtrack** on each region start (same *idea* as onset backtrack, without a spectral ODF).
